...
let
  sources = {
    x86_64-darwin = {
      ...
      hash = "sha256-rdnnBbE+UVFZ+RGm12X6KDJpKEZ1jlHZ7H3KrY6X/8U=";
    };
    aarch64-darwin = {
      url = "https://github.com/floatpane/matcha/releases/download/nightlyv0/matcha_nightly_darwin_arm64.tar.gz";
      hash = "sha256-nPM/LX+9jonGt+V2SfQu4oSbdJ+aiFgRBZ4Mxy6HgFY=";
    };
    x86_64-linux = {
      url = "https://github.com/floatpane/matcha/releases/download/nightlyv0/matcha_nightly_linux_amd64.tar.gz";
      hash = "sha256-KLCjdjqXdTW+Umv0IR9VC4JJPkX5jiKZ9w6mQeNYW1s=";
    };
    aarch64-linux = {
      url = "https://github.com/floatpane/matcha/releases/download/nightlyv0/matcha_nightly_linux_arm64.tar.gz";
      hash = "sha256-7oEA+qscMfVf2vekUNDK3yJ9kWxZTkq1iAjzUqP51TE=";
    };
  };
